class DegreeRequirementsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @degree_requirement.save
        format.html { redirect_to degree_requirements_path, notice: 'Degree requirement was successfully created.' }
  ...
  private
    ...
    def degree_requirement_params
      params.require(:degree_requirement).permit(:course_id, :major_id, :minor_id)
    end
end
